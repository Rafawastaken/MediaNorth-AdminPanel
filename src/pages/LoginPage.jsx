...
const LoginPage = () => {
  ...
  return (
      <div
          className="flex h-screen w-screen items-center justify-center bg-gradient-to-br from-[var(--dark-blue)] via-[#1B2435] to-[var(--light-blue)] px-4">
        <div
            className="w-full max-w-md rounded-2xl bg-white/5 p-10 shadow-2xl backdrop-blur-lg ring-1 ring-white/25">
          {/* Branding --------------------------------------------------- */}
          ...
          <div
              className={'border-b border-b-gray-300/25 w-75 h-1 mb-4 px-12 text-center self-center justify-self-center'}></div>
